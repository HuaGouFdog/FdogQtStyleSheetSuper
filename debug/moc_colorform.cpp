...
QT_MOC_LITERAL(1, 10, 12), // "GetUdpLogMsg"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "msg"
QT_MOC_LITERAL(4, 28, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(5, 50, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(6, 74, 32), // "on_horizontalSlider_valueChanged"
QT_MOC_LITERAL(7, 107, 5), // "value"
QT_MOC_LITERAL(8, 113, 34), // "on_horizontalSlider_2_valueCh..."
QT_MOC_LITERAL(9, 148, 34) // "on_horizontalSlider_3_valueCh..."

    },
    "ColorForm\0GetUdpLogMsg\0\0msg\0"
...
void ColorForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ColorForm *_t = static_cast<ColorForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GetUdpLogMsg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (ColorForm::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorForm::GetUdpLogMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ColorForm::GetUdpLogMsg(QString _t1)
{
